...
export const messages = {
    ...
    pt: {
        ...
        appSubtitle: 'Grave sua tela com audio do sistema e do microfone.',
        start: 'Iniciar Gravacao',
        pause: 'Pausar',
        resume: 'Retomar',
        stop: 'Parar',
        ...
        systemAudioHint: 'O audio do sistema depende do navegador e da fonte selecionada.',
        conversionHint: 'A conversao para MP4 acontece apos parar e pode demorar.',
        browserNotSupported: 'Este navegador nao suporta gravacao de tela.',
        errorStart: 'Nao foi possivel iniciar a gravacao. Verifique as permissoes.',
        errorConvert: 'Falha ao converter para MP4. Um arquivo WebM foi gerado.',
        languageLabel: 'Idioma',
        downloadReady: 'Sua gravacao esta pronta.',
        reset: 'Limpar Gravacao',
