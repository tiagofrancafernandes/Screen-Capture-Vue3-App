...
export const messages = {
    en: {
        ...
        converterTitle: 'WebM to MP4 Converter',
        converterSubtitle: 'Convert a WebM file to MP4 directly in the browser.',
        converterSelect: 'Select a WebM file',
        converterClear: 'Clear file',
        converterReady: 'MP4 is ready to download.',
        converterError: 'Failed to convert this WebM file.',
        converterDemoDownload: 'Download demo WebM',
        converterPreview: 'Preview',
    },
    pt: {
        ...
        ffmpegModeMulti: 'FFmpeg.wasm (multi-thread)',
        navRecorder: 'Gravacao',
        navConverter: 'Conversor',
        converterTitle: 'Conversor WebM para MP4',
        converterSubtitle: 'Converta um arquivo WebM para MP4 direto no navegador.',
        converterSelect: 'Selecione um arquivo WebM',
        converterClear: 'Limpar arquivo',
        converterReady: 'MP4 pronto para download.',
        converterError: 'Falha ao converter este arquivo WebM.',
        converterDemoDownload: 'Baixar WebM demo',
        converterPreview: 'Previa',
    },
} as const;
