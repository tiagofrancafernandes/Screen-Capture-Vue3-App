var createFFmpegCore = (() => {
    ...
    return function (createFFmpegCore = {}) {
        ...
        var __emscripten_tls_init = (Module['__emscripten_tls_init'] = function () {
            return (__emscripten_tls_init = Module['__emscripten_tls_init'] = Module['asm']['Oa']).apply(
                null,
                arguments
            );
        });
        ...
        var __emscripten_thread_init = (Module['__emscripten_thread_init'] = function () {
            return (__emscripten_thread_init = Module['__emscripten_thread_init'] = Module['asm']['Ra']).apply(
                null,
                arguments
            );
        });
        var __emscripten_thread_crashed = (Module['__emscripten_thread_crashed'] = function () {
            return (__emscripten_thread_crashed = Module['__emscripten_thread_crashed'] = Module['asm']['Sa']).apply(
                null,
                arguments
            );
        });
        ...
        var __emscripten_thread_exit = (Module['__emscripten_thread_exit'] = function () {
            return (__emscripten_thread_exit = Module['__emscripten_thread_exit'] = Module['asm']['Wa']).apply(
                null,
                arguments
            );
        });
        var __emscripten_check_mailbox = (Module['__emscripten_check_mailbox'] = function () {
            return (__emscripten_check_mailbox = Module['__emscripten_check_mailbox'] = Module['asm']['Xa']).apply(
                null,
                arguments
            );
        });
